...
Source0  : https://znc.in/releases/znc-1.9.0.tar.gz
Source1  : https://znc.in/releases/znc-1.9.0.tar.gz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718859411
mkdir -p clr-build
pushd clr-build
