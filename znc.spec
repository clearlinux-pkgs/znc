...
cp %{_builddir}/znc-%{version}/third_party/gtest-parallel/LICENSE %{buildroot}/usr/share/package-licenses/znc/2b8b815229aa8a61e483fb4ba0588b8b6c491890 || :
export GOAMD64=v2
pushd ../buildavx2/
GOAMD64=v3
pushd clr-build-avx2
...
/V3/usr/lib64/znc/saslplainauth.so
...
/usr/lib64/znc/saslplainauth.so
